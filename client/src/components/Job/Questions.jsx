  ...
  return (
    <fieldset>
      <div className='quest zero'>
        ...
        <p className=''>Please fill out the below if applying to work in the shop or outside.</p>
        <label>Can you lift at least 65lbs?</label>
        ...
        <p className=''>Please fill out the below if applying to work in the office.</p>
        ...
        <label>Are you experienced in microsoft or google applications (such as google docs and excel)?</label>
